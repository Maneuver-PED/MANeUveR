...
app.controller("page2Controller", function($scope,$rootScope,$modal,$log,$http) {
...
// FOR IE:
	...
	$scope.generateJSON=function(){
		...
		var resource;
		$http.post("http://127.0.0.1:8080/UI/API/0.1/",$scope.jsonStringified)
		.then(function(response){
			...
			//error
			console.log("POST-ul nu a reusit");
		});
	}
});
